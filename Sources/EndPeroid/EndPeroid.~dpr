...
uses
  ...
  Forms,
  JvUIB,
  EndPeroidFrm in 'EndPeroidFrm.pas' {frmEndPeroid},
  uCiaXml in '..\LIB\uCiaXml.pas',
  CommonLIB in '..\LIB\CommonLIB.pas',
  CommonUtils in '..\LIB\CommonUtils.pas',
  ConfirmCloseFrm in 'ConfirmCloseFrm.pas' {frmConfirmClose},
  PeriodFrm in 'PeriodFrm.pas' {frmPeriod};
...
begin
  ...
  Result := TfrmEndPeroid.Create(_MainApp);

  if initSqlConnection(TfrmEndPeroid(Result).Conn)
  then
  begin
