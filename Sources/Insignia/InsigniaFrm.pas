...
begin
    if R1.Checked = True then
      begin
//        StrSqlRoyal := 'select D.do_id ,D.do_prename,D.do_name,D.do_lname,A.ryid,A.id,A.ryrdate '+
//                          ' ,A.ryrcode,A.ryname,A.ryfname,A.ryininame,B.ry_code,B.ry_title,'+
//                          ' (A.ryname +'+ QuotedStr(' ')+ ' + A.ryfname) as FuName,'+
//                          ' A.rylevel,'+
//                          'A.ryapyear,A.rydate1,A.ryappdate, A.ryansdate ,B.ry_title ,A.rytotal,A.ryend '+
//                          'from donator D left join royal A on D.do_id  = A.id '+
//                          'left join royal_code B on A.ryrcode = B.ry_code '+
//                          'where D.do_name like ' + QuotedStr(edSearchName.Text+'%') +
//                          ' and D.do_lname like '+ QuotedStr(edSearchLName.Text+'%')+
//                          ' order by D.do_id' ;
      ...
      begin
//        StrSqlRoyal := ' select A.ryid,A.id,A.ryrdate,A.ryname,'+
//                       ' A.ryfname,A.ryininame,A.ryrcode,(A.ryname +'+ QuotedStr (' ')+
//                       ' + A.ryfname) as FuName,A.ryapyear,A.rydate1,A.ryappdate,'+
//                       ' A.ryansdate ,B.ry_code,B.ry_title ,A.rylevel,A.ryend,A.rytotal '+
//                       ' from royal A '+
//                       ' left join royal_code B on A.ryrcode = B.ry_code where ryname like ' +
//                       QuotedStr(edSearchName.Text+'%')+
//                       ' and ryfname like '+
//                       QuotedStr(edSearchLName.Text+'%') +
//                       ' order by A.ryid' ;
